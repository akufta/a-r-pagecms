---
title: Fantastic free and open source software programs for artists
author: 'A. Kufta'
pubDatetime: 2025-06-20T16:40:49Z
slug: fantastic-free-and-open-source-software-programs-for-artists
featured: false
tags:
  - software
...
![free art programs for artists](https://images.unsplash.com/photo-1512486130939-2c4f79935e4f?auto=format&fit=crop&w=1600&q=80)

Paid software often is the industry standard and there are many amazing options there too. I plan to write a post about that later! To tide you over, I have bought and personally recommend both[ Affinity Designer, Affinity Photo, and Publisher](https://affinity.serif.com/en-us/)!
...
* has a lovely, endless canvas (raster) & nicely done brush engine. Free & open source.
  * Linux, macOS & Windows. Can require some technical knowledge to install on [macOS](https://github.com/mypaint/mypaint/issues/346) (use MacPorts) & Windows.
...
* free vector and raster program 
  * multi platform, iOS mobile and iPad, Windows

[Adobe Photoshop CS2](https://helpx.adobe.com/creative-suite/kb/cs2-product-downloads.html?promoid=19SCDRQK)
...
* Linux, macOS & Windows
* As for sketching programs, there are options in [Autodesk’s Sketchbook](https://www.sketchbook.com/?locale=en) & [Mischief](https://www.madewithmischief.com/)
...
Also check out the lovely subreddit, [r/FOSSPhotography](https://www.reddit.com/r/FOSSPhotography/)
...
[DigiKam/ShowFoto](https://www.digikam.org)
...
* Decent browser photo editor that's pretty full featured. More AI focused though in 2025, but Advanced Photo Editor is similar to what previously existed.

Though Picassa is retired, [Google Photos](https://photos.google.com/)
...
* Animated sprite editor & pixel art tool (Windows, macOS, Linux) [https://www.aseprite.org](https://www.aseprite.org "https://www.aseprite.org")
* A simple web-based tool for Spriting and Pixel art. [http://piskelapp.com](http://piskelapp.com "http://piskelapp.com")
* Pixel art animation and drawing web app powered by React [https://www.pixelartcss.com/](https://www.pixelartcss.com/ "https://www.pixelartcss.com/")
* A flat pixel art editor [http://app.poxi.rocks](http://app.poxi.rocks "http://app.poxi.rocks")
* A collection of low-res primitives for creating art and games in React [https://pixel8.vsmode.org/](https://pixel8.vsmode.org/ "https://pixel8.vsmode.org/")
* an in-browser canvas tool which is great fun! [https://make8bitart.com](https://make8bitart.com "https://make8bitart.com")
* Pixel art editor built on Clojurescript + Om Play with it here: [http://jackschaedler.github.io/goya/](http://jackschaedler.github.io/goya/ "http://jackschaedler.github.io/goya/").

## Video Editing Software

Here are my recommendations and favorite free video editors, since I cannot afford Premiere Pro and [Final Cut Pro](https://geo.itunes.apple.com/us/app/final-cut-pro/id424389933?mt=12&at=1001ly2n) right now!

[VSDC](https://www.videosoftdev.com/free-video-editor)
...
[iMovie](https://geo.itunes.apple.com/us/app/imovie/id408981434?mt=12&at=1001ly2n)
...
* Blender can do so much. I write about this software shortly, but here is how to utilize it as a video editor: [quick start for using Blender as a video editor](https://danielpocock.com/quick-start-blender-video-editing)  & the video editing[feature set](https://www.blender.org/features/video-editing/).
  * Linux, macOS & Windows
...
[SketchUp: 3D modeling for everyone](https://www.sketchup.com/)
...
Paid suggestion by a reader, the 2D animation software [Moho](https://my.smithmicro.com/moho-2D-animation-software.html).
...
[Mixxx](https://www.mixxx.org/download/)

* DJ software
  * macOS, Windows, & Linux

If you're interested in the hardware side of things, my friends at Beginner Guitar HQ has written a nice, detailed guide on[ best audio mixers](https://beginnerguitarhq.com/best-audio-mixer/) with picks for every budget. 
...
* can export to PDF  &  [LibreOffice Draw](https://www.libreoffice.org/discover/draw/) can directly edit PDFs
* macOS, Windows, & Linux

[Scribus](https://www.scribus.net/) &   [GIMP](https://www.gimp.org/) can also export to PDF
...
[PDF-XChange Editor/Reader](https://pdf-xchange.eu/pdf-xchange-editor/index.htm)
...
Hope this is useful! If it was, please consider sharing the article!

### Discussion

Have you ever used free or open source software in your work? If not, are you planning to now? If you've ran into any others, feel free to share links to them  by [contacting me](https://art-res.tumblr.com/submit)!